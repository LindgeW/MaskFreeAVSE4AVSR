# https://discuss.pytorch.org/t/pytorch-implementation-of-t5/169251
    ...
    def __init__(
        ...
        for _ in range(depth):
            self.layer.append(nn.ModuleList([
                Residual(PreNorm(dim, T5SelfAttention(dim=dim, heads=heads, dim_head=dim_head, causal=causal,
                                                      dropout=dropout))),
